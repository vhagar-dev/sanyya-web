          ...
          <TabsList className="scrollbar-hide mb-6 flex h-auto w-full gap-2 overflow-x-auto bg-transparent p-0 md:mb-8 md:grid md:grid-cols-4">
            {[
              ...
              <TabsTrigger
                key={tab.value}
                value={tab.value}
                className="flex h-auto min-w-[80px] flex-shrink-0 flex-col items-center gap-1.5 rounded-xl border border-border bg-card/50 p-3 text-foreground transition-all hover:border-[hsl(217_91%_57%/0.3)] data-[state=active]:border-transparent data-[state=active]:bg-brand-gradient data-[state=active]:text-white data-[state=active]:shadow-[0_10px_40px_-10px_hsl(217_91%_57%/0.5)] md:flex-shrink md:p-4"
              >
              ...
              <div className="grid items-center gap-8 md:grid-cols-2">
                <div>
                  <PanelHeading
                    ...
                    iconBg="bg-brand-gradient shadow-[0_10px_30px_-10px_hsl(217_91%_57%/0.6)]"
                        ...
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <button className="group relative">
                              <div className="absolute inset-0 rounded-full bg-[hsl(217_91%_57%/0.4)] blur-md transition group-hover:bg-[hsl(217_91%_57%/0.6)]" />
                              <Info className="relative z-10 size-5 cursor-pointer text-[hsl(217_91%_38%)] transition-colors hover:text-[hsl(258_90%_38%)]" />
                            </button>
                          </TooltipTrigger>
                          <TooltipContent
                            side="right"
                          ...
                          >
                            <div className="p-4">
                              ...
                              <p className="mb-4 text-xs leading-relaxed text-muted-foreground">
                                ...
                                "IPA" and "Isopropyl Alcohol" are the same, we calculate the
                              ...
                              <div className="mb-3 rounded-lg border border-border bg-secondary/50 p-3">
                                <svg viewBox="0 0 200 100" className="h-20 w-full">
                                  <line x1="20" y1="80" x2="180" y2="80" stroke="hsl(0 0% 40% / 0.3)" />
                                  <line x1="20" y1="80" x2="20" y2="10" stroke="hsl(0 0% 40% / 0.3)" />
                                  <line x1="20" y1="80" x2="160" y2="25" stroke="url(#vA)" strokeWidth="2.5" strokeLinecap="round" />
                                  <circle cx="160" cy="25" r="4" fill="hsl(217 91% 57%)" />
                                  <text x="165" y="22" fill="hsl(217 91% 75%)" fontSize="9" fontWeight="600">
                                    "IPA"
                                  </text>
                                  <line x1="20" y1="80" x2="170" y2="35" stroke="url(#vB)" strokeWidth="2.5" strokeLinecap="round" />
                                  <circle cx="170" cy="35" r="4" fill="hsl(258 90% 55%)" />
                                  <text x="175" y="38" fill="hsl(258 90% 75%)" fontSize="9" fontWeight="600">
                                    "Isopropyl..."
                                  </text>
                                  ...
                                  <defs>
                                    <linearGradient id="vA" x1="0%" y1="0%" x2="100%" y2="0%">
                                      <stop offset="0%" stopColor="hsl(217 91% 57%)" stopOpacity="0.3" />
                                      <stop offset="100%" stopColor="hsl(217 91% 57%)" />
                                    </linearGradient>
                                    <linearGradient id="vB" x1="0%" y1="0%" x2="100%" y2="0%">
                                      <stop offset="0%" stopColor="hsl(258 90% 55%)" stopOpacity="0.3" />
                              ...
                              <div className="flex items-center justify-between rounded-md border border-emerald-500/20 bg-emerald-500/10 px-3 py-2">
                                ...
                                <span className="font-mono text-sm font-bold text-emerald-400">99.2%</span>
                              </div>
                            </div>
                          </TooltipContent>
                        </Tooltip>
                  ...
                  <p className="mt-4 text-sm leading-relaxed text-muted-foreground md:text-base lg:text-lg">
                    ...
                    <span className="font-semibold text-[hsl(217_91%_38%)]">cosine similarity</span>{" "}
                ...
                <div className="rounded-2xl border border-border bg-secondary/40 p-5 sm:p-6">
                  <div className="mb-6 flex items-center justify-between gap-2">
                    ...
                    <div className="relative mx-2 flex-1">
                      <div className="h-1 rounded-full bg-gradient-to-r from-[hsl(217_91%_57%)] via-emerald-400 to-[hsl(258_90%_55%)]" />
                      <motion.div
                        initial={{ scale: 0 }}
                        whileInView={{ scale: 1 }}
                        viewport={{ once: true }}
                        transition={{ delay: 0.3 }}
                        className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 whitespace-nowrap rounded-full bg-emerald-500 px-3 py-1 text-[11px] font-bold text-white shadow-lg"
                      >
                        98% Match
                      </motion.div>
                    </div>
                    ...
                    {[...Array(15)].map((_, i) => (
                      <motion.div
                        ...
                        className={`absolute size-2 rounded-full ${
                          i < 7 ? "bg-[hsl(217_91%_57%)]" : "bg-[hsl(258_90%_55%)]"
                        }`}
                        style={{
                          left: `${15 + ((i * 41) % 70)}%`,
                          top: `${15 + ((i * 23) % 60)}%`,
              ...
              <div className="grid items-center gap-8 md:grid-cols-2">
                <div>
                  ...
                  <p className="mt-4 text-sm leading-relaxed text-muted-foreground md:text-base lg:text-lg">
                    ...
                    extract data from messy invoices and crumpled packing slips instantly. It
                    reads documents like a human.
                  </p>
                </div>
                <div className="rounded-2xl border border-border bg-secondary/40 p-5 sm:p-6">
                    ...
                    <div className="space-y-3 text-sm">
                      <div className="flex items-center justify-between">
                        <div className="relative">
                          ...
                          <div className="absolute -inset-1 rounded border-2 border-[hsl(217_91%_57%)] bg-[hsl(217_91%_57%/0.1)]" />
                        </div>
                      ...
                      <div className="border-t border-border pt-3">
                        <div className="relative inline-block">
                          ...
                          <div className="absolute -inset-1 rounded border-2 border-emerald-400 bg-emerald-400/10" />
                        </div>
                      </div>
                  ...
                  <div className="mt-4 flex flex-wrap justify-center gap-3">
                    {[
                      { color: "bg-[hsl(217_91%_57%)]", label: "Invoice #" },
                      { color: "bg-emerald-400", label: "Vendor" },
                      { color: "bg-amber-400", label: "Line Item" },
                      { color: "bg-violet-400", label: "Amount" },
                    ].map((i) => (
                      <span key={i.label} className="flex items-center gap-1 text-xs text-muted-foreground">
              ...
              <div className="grid items-center gap-8 md:grid-cols-2">
                <div>
                  <PanelHeading
                    ...
                    iconBg="bg-gradient-to-br from-cyan-500 to-blue-600 shadow-[0_10px_30px_-10px_rgb(6_182_212/0.6)]"
                  ...
                  <p className="mt-4 text-sm leading-relaxed text-muted-foreground md:text-base lg:text-lg">
                    ...
                    <span className="font-semibold text-cyan-400">directly on the device</span>.
                    No App Store downloads, no latency.
                  </p>
                </div>
                <div className="flex justify-center">
                  <div className="relative">
                    <div className="absolute -inset-8 rounded-[4rem] bg-gradient-to-b from-[hsl(217_91%_57%/0.2)] to-transparent blur-2xl" />
                    <div className="relative h-[420px] w-52 rounded-[2.5rem] border border-border bg-gradient-to-b from-card to-secondary p-3 shadow-2xl">
                      <div className="flex h-full w-full flex-col overflow-hidden rounded-[2rem] bg-background">
                        <div className="relative flex flex-1 items-center justify-center bg-gradient-to-b from-card to-secondary p-4">
                          ...
                          >
                            <div className="absolute left-0 top-0 size-6 rounded-tl border-l-2 border-t-2 border-[hsl(217_91%_57%)]" />
                            <div className="absolute right-0 top-0 size-6 rounded-tr border-r-2 border-t-2 border-[hsl(217_91%_57%)]" />
                            <div className="absolute bottom-0 left-0 size-6 rounded-bl border-b-2 border-l-2 border-[hsl(217_91%_57%)]" />
                            <div className="absolute bottom-0 right-0 size-6 rounded-br border-b-2 border-r-2 border-[hsl(217_91%_57%)]" />

                            <div className="absolute inset-3 rotate-1 rounded-lg bg-white p-3 shadow-lg">
                              ...
                              <motion.div
                                ...
                                className="absolute -right-1 -top-1 grid size-6 place-items-center rounded-full bg-emerald-500 shadow-lg"
                              >
                                <Check className="size-3 text-white" />
                              </motion.div>
                            </div>
                            <motion.div
                              className="absolute left-0 right-0 h-1 bg-gradient-to-r from-transparent via-[hsl(217_91%_57%/0.5)] to-transparent"
                              animate={{ top: ["0%", "100%", "0%"] }}
                        ...
                        <div className="space-y-2 bg-secondary/50 p-4">
                          <div className="rounded-xl bg-emerald-500 py-3 text-center">
            ...
            <Panel>
              <div className="grid items-center gap-8 md:grid-cols-2">
                <div>
                  ...
                  />
                  <p className="mt-4 text-sm leading-relaxed text-muted-foreground md:text-base lg:text-lg">
                    We memorize your price history. If a vendor quietly raises a component price
                    by 10%, or if shipping spikes, the system{" "}
                    <span className="font-semibold text-rose-400">flags the variance</span> for
                    CFO review before payment.
                  </p>
                </div>
                <div className="rounded-2xl border border-border bg-secondary/40 p-5 sm:p-6">
                  ...
                  <div className="relative h-40">
                    <svg className="h-full w-full" viewBox="0 0 300 120" preserveAspectRatio="none">
                      {[0, 30, 60, 90, 120].map((y) => (
                        <line key={y} x1="0" y1={y} x2="300" y2={y} stroke="hsl(0 0% 30%)" strokeWidth="1" />
                      ))}
                      <motion.path
                        d="M 0 80 L 50 78 L 100 82 L 150 79 L 200 81 L 220 80"
                        fill="none"
                        stroke="hsl(217 91% 57%)"
                        strokeWidth="3"
                        strokeLinecap="round"
                    ...
                    <motion.div
                      ...
                      className="absolute right-4 top-2 flex items-center gap-1 rounded-full border border-red-500/20 bg-red-500/10 px-2 py-1 text-xs font-semibold text-red-400"
                    >
                      <AlertTriangle className="size-3" /> +12% Variance
                    </motion.div>
                    <div className="absolute left-0 top-0 text-xs text-muted-foreground">$0.50</div>
                    <div className="absolute bottom-0 left-0 text-xs text-muted-foreground">$0.40</div>
                  </div>
                  <div className="mt-4 flex items-center justify-center gap-4 border-t border-border pt-4">
                    <span className="flex items-center gap-1 text-xs text-muted-foreground">
                      <span className="h-0.5 w-3 rounded bg-[hsl(217_91%_57%)]" /> Historical Avg
                    </span>
                    <span className="flex items-center gap-1 text-xs text-muted-foreground">
...
function Panel({ children }: { children: React.ReactNode }) {
  return (
    <div className="glass rounded-2xl p-5 sm:p-6 md:p-10">{children}</div>
  );
}
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="min-w-0">
        ...
        <span className="hidden rounded bg-secondary px-2 py-0.5 font-mono text-[10px] text-muted-foreground sm:inline md:text-xs">
          {sub}
        </span>
      </div>
    </div>
...
function Term({ label, tone }: { label: string; tone: "brand" | "pink" }) {
  const styles =
    tone === "brand"
      ? "bg-[hsl(217_91%_57%/0.1)] border-[hsl(217_91%_57%/0.3)] text-[hsl(217_91%_38%)]"
      : "bg-[hsl(258_90%_55%/0.1)] border-[hsl(258_90%_55%/0.3)] text-[hsl(258_90%_38%)]";
  return (
    <div className="flex flex-shrink-0 flex-col items-center">
      <div
        className={`grid size-16 place-items-center rounded-xl border-2 md:size-20 ${styles}`}
      >
