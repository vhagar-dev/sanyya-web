    ...
    fields: [
      {
        label: "Lot #",
        value: "FBS-2024-A881",
        color: "ring-[hsl(269_80%_57%)]/70 bg-[hsl(269_80%_57%/0.12)]",
      },
      {
        label: "Temp",
        value: "-20°C",
        color: "ring-[hsl(168_78%_60%)]/70 bg-[hsl(168_78%_60%/0.12)]",
      },
    ],
  },
  {
    ...
    fields: [
      {
        label: "Batch",
        value: "VWR-9921",
        color: "ring-[hsl(25_90%_60%)]/70 bg-[hsl(25_90%_60%/0.12)]",
      },
      {
        label: "Storage",
        value: "2-8°C",
        color: "ring-[hsl(272_75%_72%)]/70 bg-[hsl(272_75%_72%/0.12)]",
      },
    ],
  },
  {
    ...
    fields: [
      {
        label: "Lot",
        value: "TF-A22-9981",
        color: "ring-[hsl(38_92%_60%)]/70 bg-[hsl(38_92%_60%/0.12)]",
      },
      {
        label: "Exp",
        value: "06/2026",
        color: "ring-[hsl(160_84%_55%)]/70 bg-[hsl(160_84%_55%/0.12)]",
      },
    ],
  },
];
  ...
  return (
    <div className={cn("grid gap-4 sm:grid-cols-2 lg:grid-cols-3", className)}>
      {vendors.map((v) => (
        <div
          key={v.name}
          className="rounded-xl border border-border bg-[hsl(0_0%_98%)] p-3 shadow-xl"
        >
          ...
          <div className="mt-3 flex items-center justify-between rounded-md border border-[hsl(0_0%_85%)] bg-[hsl(0_0%_96%)] px-2 py-1 text-[9px] text-[hsl(0_0%_30%)]">
            ...
            <span className="tabular-nums text-[hsl(160_84%_25%)]">99.{v.name.length % 9}%</span>
          </div>
        </div>
      ))}
    </div>
